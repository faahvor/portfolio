  ...
  const experiences = [
    {
      ...
      description: `
        At Gemz Software, we specialize in building software solutions tailored to meet diverse client needs. 
        As a frontend developer, I focused on full-stack development projects, primarily utilizing <strong>React</strong> 
        and <strong>Next.js</strong> to deliver high-quality web applications.
  
        I led multiple projects from conception to completion, ensuring timely delivery while maintaining 
        the highest standards of web development. My responsibilities included building dynamic, responsive 
        websites using <strong>React.js</strong> and <strong>Next.js</strong>, as well as creating user-friendly 
        platforms with <strong>WordPress</strong>.
  
        Collaborating closely with cross-functional teams, I ensured adherence to deadlines and implemented 
        industry best practices to optimize performance and user experience. My role required a balance of 
        technical expertise, leadership, and a commitment to delivering innovative software solutions.
      `,
      link: "https://gemzsoftware.com/"
    }
