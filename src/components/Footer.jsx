...
const Footer = () => {
  ...
  return (
    <>
      ...
      >
        <a href="mailto:tinafavour2018@gmail.com" target="_blank" rel="noopener noreferrer" className="my-5">
          <img 
        ...
        <a href="https://github.com/faahvor" target="_blank" rel="noopener noreferrer" className="my-5">
          <img 
        ...
        <a href="https://www.linkedin.com/in/favour-ifurukpe/" target="_blank" rel="noopener noreferrer" className="my-5">
          <img 
            className="hover-svg w-7 h-7"
            src={linkedinSvg} 
        ...
        <a href="https://wa.me/2347048018665" target="_blank" rel="noopener noreferrer" className="my-5">
          <img 
            className="hover-svg w-8 h-8"
            src={whatsappSvg} 
        ...
        <div className="block md:hidden">
          <ul className="flex justify-center items-center flex-wrap gap-3">
            <li className="mx-2 my-1">
              <a href="mailto:tinafavour2018@gmail.com" target="_blank" rel="noopener noreferrer">
                <img className="w-7 h-7" src={mailSvg} alt="Gmail" />
              </a>
            </li>
            <li className="mx-2 my-1">
              <a href="https://github.com/faahvor" target="_blank" rel="noopener noreferrer">
                <img className="w-5 h-5" src={githubSvg} alt="GitHub" />
              </a>
            </li>
            <li className="mx-2 my-1">
              <a href="https://www.linkedin.com/in/favour-ifurukpe/" target="_blank" rel="noopener noreferrer">
            ...
            <li className="mx-2 my-1">
              <a href="https://wa.me/2347048018665" target="_blank" rel="noopener noreferrer">
